...
- [Advanced Markdown Guide](#advanced-markdown-guide)
  - [Table of Contents](#table-of-contents)
  - [Why markdown?](#why-markdown)
  - [Markdown basics](#markdown-basics)
    - [Image with alt \& title](#image-with-alt--title)
  - [Advanced Formatting tips](#advanced-formatting-tips)
    - [`left` alignment](#left-alignment)
    - [`right` alignment](#right-alignment)
    - [`center` alignment example](#center-alignment-example)
    - [Horizontal images no gap](#horizontal-images-no-gap)
    - [Horizontal images with gap](#horizontal-images-with-gap)
    - [Vertical images with gap](#vertical-images-with-gap)
    - [Adding video](#adding-video)
    - [light/dark mode images](#lightdark-mode-images)
    - [Using footnotes](#using-footnotes)
    - [Strikethru text in markdown](#strikethru-text-in-markdown)
    - [Tiny text in markdown](#tiny-text-in-markdown)
    - [Text box](#text-box)
    - [`collapse` Sections](#collapse-sections)
    - [Call outs](#call-outs)
    - [`additional links`](#additional-links)
    - [Badges](#badges)
    - [Nice looking file tree](#nice-looking-file-tree)
    - [Using CSS in Readme](#using-css-in-readme)
